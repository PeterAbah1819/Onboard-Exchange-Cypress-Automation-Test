describe('Check in', () => {
    ...
    //it('find patient')
    cy.get(':nth-child(1) > .Patients__action > .Patients__checkin-container > [data-cy=patients-list-patient-checkin]').click()
    ...
    it('Patient Checkin Popup')
        ...
        .type('registration')
        cy.get('[class="BillingItemsSelectWithCategories__option-row"]').contains('registration').click()
